package com.hyeran.android.travely_manager.db
...
class SharedPreferencesController {
    ...
    companion object {
        ...
        @Volatile private var sharedPreferencesManager: SharedPreferencesController? = null

        val instance: SharedPreferencesController?
            get() {
                if (sharedPreferencesManager == null) {
                    synchronized(SharedPreferencesController::class.java) {
                        if (sharedPreferencesManager == null)
                            sharedPreferencesManager = SharedPreferencesController()
                    }
                }
